...
const Register = () => {
    const { emailSignUp, updateProf, googleSign, githubSign } = useContext(UserContext);
    ...
    return (
        <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-300 text-gray-900">
	<h1 className="text-2xl font-bold text-center">Register</h1>
			...
			<input type="text" name="FullName" id="FullName" placeholder="Full Name" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
		</div>
            <div className="space-y-1 text-sm">
