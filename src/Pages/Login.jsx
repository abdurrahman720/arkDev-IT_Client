...
const Login = () => {
    const { user, emailSignIn, googleSign, githubSign } = useContext(UserContext);
	...
	<p className="text-xs text-center sm:px-6 text-gray-900">Don't have an account?
		<Link rel="noopener noreferrer" to='/register' className="underline text-gray-700">Sign up</Link>
	</p>
</div>
    );
};
